...
class HybridTrainPipe(Pipeline):
    def __init__(self, batch_size, num_threads, device_id, data_dir, crop, dali_cpu=False, local_rank=0, world_size=1):
        ...
        self.cmnp = ops.CropMirrorNormalize(device="gpu",
                                            ...
                                            mean=[113.19, 115.88, 105.23],
                                            std=[47.02, 43.78, 47.82])
...
if __name__ == '__main__':
    train_loader = get_imagenet_iter_dali(type='train', image_dir='/opt/data/private/dataset/ILSVRC2012/', batch_size=256,
                                          num_threads=5, crop=224, device_id=[0,1], num_gpus=2)
    print('start iterate')
    start = time.time()
