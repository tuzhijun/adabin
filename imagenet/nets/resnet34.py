...
from utils.binarylib import Expand_Conv2d, Maxout
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = Expand_Conv2d(inplanes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.nonlinear1 = Maxout(planes)

        self.conv2 = Expand_Conv2d(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, deep_stem=False,
        ...
        for m in self.modules():
            ...
            elif isinstance(m, Expand_Conv2d):
                n = m.kernel_size[0] * m.kernel_size[1] * m.out_channels
                m.weight.data.normal_(0, math.sqrt(2. / n))
